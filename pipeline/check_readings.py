...
NUM_ONLY = [
    # 두 글자 이상은 숫자 부분만 본다 — 단위·조사를 묶으면 뒤 글자 오독이 숫자 오독이 된다(E01 s15)
    ("3.75초나", "삼 점 칠 오"), ("9.167초로", "구 점 일 육 칠"), ("7컷", "일곱"),
    ("118센티미터", "백십팔"), ("-16.5", "마이너스 십육 점 오"),
    # 한 글자면 뒤 단위 한 낱말까지 붙인다. 조사는 뺀다 —
    # '이'·'일'·'사'는 문장에 지천이라 그 한 글자만으로는 엉뚱한 자리에 걸린다(E01 s10)
    ("2초", "이 초"), ("4초", "사 초"), ("2.00초", "이 초"), ("4명과", "네 명"),
    ("1초짜리를", "일 초"), ("1개입니다", "한 개"), ("0개", "영 개"), ("2프레임", "이 프레임"),
    ("3장을", "세 장"), ("1회", "일 회"),
    ("5", "오"),                      # 단위가 없으면 붙일 것도 없다
]
