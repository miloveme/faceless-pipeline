...
#   E01 v5  24씬  3,195자 / 366.1초 = 8.73  (음악 감독 실측, 절대평균오차 0.74초)
#   E01 v8  29씬  중간 판본             8.88  (음악 감독 실측)
#   E01 v8  29씬  3,631자 / 408.8초 = 8.88  (엔지니어 실측, 최종 음성)
# 표본이 8.73~8.88 에 모여 있고 가늠하는 값이라 **8.7 을 안 옮긴다**(음악 감독 판단).
# 옮기면 지난 편들의 가늠이 갈리는데, 얻는 정확도는 100자에 0.2초다.
